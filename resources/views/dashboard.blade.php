        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body text-center px-4 pb-4">
                    ...
                    <div class="d-grid gap-2">
                        <a href="https://whatsapp.com/channel/0029VbEIyPKFi8xhoHYXrk2i" target="_blank" class="btn btn-success">
                            <i class="feather-users me-2"></i> Join WhatsApp Channel
                        </a>
                        <a href="https://t.me/proxworldhq" target="_blank" class="btn" style="background-color: #229ED9; color: white;">
