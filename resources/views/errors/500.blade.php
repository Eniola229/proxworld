        ...
        <div class="minimal-card-wrapper">
            <div class="card mb-4 mt-5 mx-4 mx-sm-0 position-relative text-center">
                ...
                <div class="card-body p-sm-5 pt-5">
                    <h1 class="display-4 fw-bolder text-danger mb-3">500</h1>
                    <h2 class="fs-20 fw-bolder mb-3">Internal Server Error</h2>
                    ...
                    <div class="mt-5 text-muted fs-11">
                        If the problem persists, kindly contact support.
                    </div>
                </div>
            </div>
        </div>
