            ...
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <div class="card">
                        ...
                        <div class="card-body">
                            @php $assignedPermissions = old('permissions', $role->permissions->pluck('name')->toArray()); @endphp
                            ...
                            <form method="POST" action="{{ route('admin.roles.update', $role->id) }}">
                                ...
                                <div class="mb-4">
                                    ...
                                    @enderror
                                    <small class="text-muted">Renaming this role does not change any admin's assignment — admins keep the role, just under its new name.</small>
                                </div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="row g-2">
                                        ...
                                        @empty
                                            <div class="col-12">
                                                <p class="text-muted fs-12 mb-0">No permissions exist yet for the "admin" guard.</p>
                                            </div>
                                        @endforelse
                                    </div>
                                </div>
