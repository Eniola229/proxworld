...
Route::middleware('admin.auth')->group(function () {
    ...
    Route::middleware('permission:orders.view')->group(function () {
        ...
        Route::post('/orders/{order}/check-status', [\App\Http\Controllers\Admin\OrderController::class, 'checkStatus'])
            ->middleware('permission:orders.manage')->name('orders.check-status');
    ...
    Route::middleware('permission:customers.view')->group(function () {
        ...
        Route::put('/customers/{user}', [\App\Http\Controllers\Admin\CustomerController::class, 'update'])
            ->middleware('permission:customers.suspend')->name('customers.update');
        Route::post('/customers/{user}/adjust-balance', [\App\Http\Controllers\Admin\CustomerController::class, 'adjustBalance'])
            ->middleware('permission:wallet.adjust')->name('customers.adjust-balance');
    });

    Route::middleware('permission:resellers.view')->group(function () {
        ...
        Route::post('/resellers/{reseller}/approve', [\App\Http\Controllers\Admin\ResellerController::class, 'approve'])
            ->middleware('permission:resellers.approve')->name('resellers.approve');
        Route::post('/resellers/{reseller}/reject', [\App\Http\Controllers\Admin\ResellerController::class, 'reject'])
            ->middleware('permission:resellers.approve')->name('resellers.reject');
        Route::post('/resellers/{reseller}/status', [\App\Http\Controllers\Admin\ResellerController::class, 'toggleStatus'])
            ->middleware('permission:resellers.suspend')->name('resellers.status');
    });

    Route::middleware('permission:reseller-withdrawals.view')->group(function () {
        ...
        Route::post('/reseller-withdrawals/{withdrawal}/approve', [\App\Http\Controllers\Admin\ResellerWithdrawalController::class, 'approve'])
            ->middleware('permission:reseller-withdrawals.process')->name('reseller-withdrawals.approve');
        Route::post('/reseller-withdrawals/{withdrawal}/reject', [\App\Http\Controllers\Admin\ResellerWithdrawalController::class, 'reject'])
            ->middleware('permission:reseller-withdrawals.process')->name('reseller-withdrawals.reject');
    });

    Route::middleware('permission:referral-withdrawals.view')->group(function () {
        ...
        Route::post('/referral/withdrawals/{withdrawal}/approve-bank', [\App\Http\Controllers\Admin\ReferralWithdrawalController::class, 'approveBank'])
            ->middleware('permission:referral-withdrawals.process')->name('referral.withdrawals.approve-bank');
        Route::post('/referral/withdrawals/{withdrawal}/approve-wallet', [\App\Http\Controllers\Admin\ReferralWithdrawalController::class, 'approveWallet'])
            ->middleware('permission:referral-withdrawals.process')->name('referral.withdrawals.approve-wallet');
        Route::post('/referral/withdrawals/{withdrawal}/reject', [\App\Http\Controllers\Admin\ReferralWithdrawalController::class, 'reject'])
            ->middleware('permission:referral-withdrawals.process')->name('referral.withdrawals.reject');
    });
    ...
    Route::middleware('permission:pricing.view')->group(function () {
        ...
        Route::put('/settings/pricing', [PricingSettingsController::class, 'update'])
            ->middleware('permission:pricing.manage')->name('settings.pricing.update');
    });
    ...
    Route::middleware('permission:currencies.manage')->group(function () {
        ...
        Route::post('/exchange-rates/{currency}/refresh', [\App\Http\Controllers\Admin\ExchangeRateController::class, 'refresh'])->name('exchange-rates.refresh');
    ...
    Route::middleware('permission:admins.view')->group(function () {
        ...
        Route::get('/admins/create', [AdminManagementController::class, 'create'])
            ->middleware('permission:admins.manage')->name('admins.create');
        Route::post('/admins', [AdminManagementController::class, 'store'])
            ->middleware('permission:admins.manage')->name('admins.store');
        ...
        Route::get('/admins/{admin}/edit', [AdminManagementController::class, 'edit'])
            ->middleware('permission:admins.manage')->name('admins.edit');
        Route::put('/admins/{admin}', [AdminManagementController::class, 'update'])
            ->middleware('permission:admins.manage')->name('admins.update');
        Route::delete('/admins/{admin}', [AdminManagementController::class, 'destroy'])
            ->middleware('permission:admins.manage')->name('admins.destroy');
        Route::get('/admins/{admin}/logs', [AdminManagementController::class, 'logs'])
            ->middleware('permission:activity-logs.view')->name('admins.logs');
    });
